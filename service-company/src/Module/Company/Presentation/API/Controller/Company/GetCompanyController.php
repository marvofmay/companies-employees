...
use App\Module\Company\Presentation\API\Action\Company\AskCompanyAction;
...
final class GetCompanyController extends AbstractController
{
    ...
    public function get(string $uuid,  AskCompanyAction $askCompanyAction): JsonResponse
    {
        try {
            ...
            return new JsonResponse(['data' => $askCompanyAction->ask($uuid),], Response::HTTP_OK);
